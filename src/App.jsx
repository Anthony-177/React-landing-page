	...
	return (
		<div className="min-h-screen flex flex-col text-white">
			<main className="container mx-auto px-6 pt-16 flex-1 text-center">
				...
				<h1 className="text-3xl md:text-6xl lg:text-8xl uppercase font-black mb-8">The Fan club</h1>

				<p className="text-base md:text-lg lg:text-2xl mb-8">A place where fans share their thoughts on live matches</p>
				...
				<form 
					action=" https://www.getrevue.co/profile/Anthony22/add_subscriber" 
					method="post" 
					id="revue-form"
					name="revue-form"
					target="_blank">
					...
					<div className="opacity-75 italic">
						By subscribing, you agree with Fan club's <a target="_blank" href="https://www.getrevue.co/terms" className="hover:opacity-80 duration-150">Terms of Service</a> and <a target="_blank" href="https://www.getrevue.co/privacy" className="hover:opacity-80 duration-150">Privacy Policy</a>.
					</div>
			...
			<footer className="container mx-auto p-6">
				<div className="flex flex-col md:flex-row items-center justify-between">
					<p className="mb-4 md:mb-0 md:text-xl"> ANTHONY</p>
